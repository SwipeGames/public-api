...
/**
 * CreateFreeRoundsResponse Class Doc Comment
 *
 * @category Class
 * @package  SwipeGames\PublicApi
 * @author   OpenAPI Generator team
 ...
 */
class CreateFreeRoundsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateFreeRoundsResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Free rounds ID (internal).
     *
     * @return self
     */
     ...
     * Sets ext_id
     *
     * @param string $ext_id Free rounds ID (external). This is provided in the request.
     *
     * @return self
     */
